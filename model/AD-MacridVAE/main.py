...
ARG.add_argument('--data', type=str, default='../../data/ml-100k-by_user',
                 help='data directory.')
...
ARG.add_argument('--kfac', type=int, default=5,
...
ARG.add_argument('--dis_hid', type=int, default=100,
                 help='Dimension of prior discriminator.')
ARG.add_argument('--cudaID', type=int, default=None,
                 help='Denote CUDA ID.')
ARG.add_argument('--log', type=str, default=None,
                 help='The log file path.')
ARG.add_argument('--intern', type=int, default=50,
                 help='Report interval.')
ARG.add_argument('--tr_step', type=int, default=1,
                 help='Augmenter train interval.')
ARG.add_argument('--search', action='store_true', default=False,
                 help='Set grid search.')
ARG.add_argument('--save_name', type=str, default=None,
                 help='Save model to ./saved_models/')
ARG.add_argument('--load', action='store_true', default=False,
                 help='Load model from ./saved_models/')
ARG.add_argument('--measure', type=str, default='JSD',
                 help='Prior matching measurement')
...
def valid_vae(vad_data_tr, vad_data_te, model, arg, device, save_emb):
    VAE = model.D
    VAE.eval()
    ...
    if save_emb:
        ...
        if arg.type == 'data':
            ...
            np.save('z_model.npy', z.detach().cpu().numpy())
        else:
            print('type wrong')
